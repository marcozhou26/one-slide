...
- Do not apply the vertical-list rail to a single formal chain. The brand branch remains `Brand Department → Brand Director → Brand Strategy Manager`, with bottom exit and top entry at both levels.
